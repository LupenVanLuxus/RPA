...
namespace VajaNajprejBaza.Controllers
{
    ...
    {
        private ADWEnitities db = new ADWEnitities();
        ...
        public ActionResult Create([Bind(Include = "ProductID,Name,ProductNumber,Color,StandardCost,ListPrice,Size,Weight,ProductCategoryID,ProductModelID,SellStartDate," +
            "SellEndDate,DiscontinuedDate,ThumbNailPhoto,ThumbnailPhotoFileName")] Product product,
            HttpPostedFileBase file)
        {
            ...
            if (ModelState.IsValid)
            {
                if (file != null)
                {
                    ...
                    //shrani sliko kot zaporedje bytov

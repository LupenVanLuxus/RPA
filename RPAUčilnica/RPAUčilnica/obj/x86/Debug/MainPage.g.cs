#pragma checksum "C:\Rpa\RPA\RPAUčilnica\RPAUčilnica\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "96F92BE4CA95EEFF4DD656B47F9948A2"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace RPAUčilnica
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::RPAUčilnica.Model.Module dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::RPAUčilnica.Model.Module) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::RPAUčilnica.Model.Module)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::RPAUčilnica.Model.Module obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj7_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::RPAUčilnica.Model.Poglavja dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::RPAUčilnica.Model.Poglavja) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::RPAUčilnica.Model.Poglavja)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::RPAUčilnica.Model.Poglavja obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::RPAUčilnica.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::RPAUčilnica.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::RPAUčilnica.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_VsaPoglavja(global::System.Collections.ObjectModel.ObservableCollection<global::RPAUčilnica.Model.Poglavja> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 3: // MainPage.xaml line 31
                {
                    this.detailGrid = (global::Windows.UI.Xaml.Controls.GridView)(target);
                }
                break;
            default:
                break;

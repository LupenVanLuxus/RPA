...
namespace RPAUčilnica.Model
{
    class KlicServisa
    {
        ...
        public static async Task PoulatePoglavja(ObservableCollection<Poglavja> poglavja)
        {
            string url = začetekPoti + funkcija + konecPoti;
            //string url = "https://eucilnica.scng.si/webservice/rest/server.php?wstoken=10ee27a3802957bcb49252cfda803d81%20&wsfunction=core_course_get_contents&courseid=133&moodlewsrestformat=json";
